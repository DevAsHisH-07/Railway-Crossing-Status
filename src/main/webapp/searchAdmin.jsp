...
<body>
	...
	<nav>
		<div style="color: #dc3545; font-weight: bold;">Railway Crossing
			Status</div>
	</nav>
	...
	<div>
		...
		<table border="1">
			...
			<tr>
				...
				<td><a href="updateCrossing.jsp?id=<%= crossing.getId() %>"
					style="color: #343a40;">Update</a> | <a
					href="deleteCrossing.jsp?id=<%= crossing.getId() %>"
					style="color: #343a40;">Delete</a></td>
			</tr>
			<%
                            }
                        %>
		...
		<form action="searchAdmin.jsp" method="post">
			<label for="crossingName">Crossing Name:</label> <input type="text"
				id="crossingName" name="crossingName" required> <input
